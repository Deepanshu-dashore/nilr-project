...
export const metadata: Metadata = {
  title: "Disclaimer | CVRU Khandwa - NLRI Campus",
      ...
      <div className="container mx-auto px-4 pb-20">
        <div className="p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <p className="leading-relaxed">
              Every coordinated technological effort is consistently made by our IT cell to keep the portal securely up and running smoothly. However, CVRUK-NLRI takes no tangible responsibility for, and strictly will not be legally liable for, the website being temporarily unavailable due to technical contingencies, server maintenance, or issues fundamentally beyond our structural control.
            </p>
          </div>
        </div>
      </div>
