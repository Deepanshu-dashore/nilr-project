...
export default function AdmissionPage() {
  ...
  const fetchEnquiries = async (tab: string) => {
    setIsLoading(true);
    try {
      const url = tab === "all" 
        ? API_ENDPOINTS.ENQUIRY.GET_EXCLUDE_SUBJECT("Other/General Enquiry")
        : API_ENDPOINTS.ENQUIRY.GET_BY_SUBJECT(tab);
      ...
      */}
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "Admission", href: "/admin/admission" },
          { label: "List" }
        ]}
      />
      ...
      <DataTable
        ...
        hiddenActions={['edit']}
        tabs={[
          { label: "All Admission", value: "all" },
          { label: "Vocational training", value: "Vocational training" },
          { label: "Diploma", value: "Diploma" },
          { label: "Certificate", value: "Certificate" },
          { label: "Postgraduate", value: "Postgraduate" },
          { label: "Short-term Training", value: "Short-term Training" },
        ]}
        activeTab={activeTab}
