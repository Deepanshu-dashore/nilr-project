      ...
      <div className="bg-gray-100 h-96 w-full flex flex-col justify-center items-center gap-4">
        <div className="p-2 bg-gray-200 rounded-lg flex items-baseline">
          <svg
            ...
            className="h-14 text-gray-500 animate-[spin_20s_linear_infinite]"
            viewBox="0 0 24 24"
          >
            <path
              fill="currentColor"
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-8 text-gray-400 animate-[spin_20s_linear_infinite]"
            viewBox="0 0 24 24"
          >
            <path
              fill="currentColor"
        ...
        <h1 className="text-3xl border-b border-gray-300 pb-2">
          Build in future
        </h1>
        <p className="text-sm">We are working on it</p>
      </div>
    </div>
  );
}
