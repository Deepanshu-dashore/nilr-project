...
function TagList({
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between border-gray-200 mb-5 ml-1 border-b pb-3">
        ...
        <button
          type="button"
          onClick={onAdd}
          className="flex items-center border border-indigo-200 cursor-pointer gap-1 text-xs font-bold text-indigo-600 hover:text-indigo-800 transition-colors px-2 py-1 rounded-lg hover:bg-indigo-50"
        >
      ...
      <div className="space-y-2">
        {items.map((item, i) => (
          <div key={i} className="flex items-center gap-2">
            <span className="w-8 h-8 shrink-0 rounded-lg bg-gray-100 border border-gray-200 flex items-center justify-center text-xs font-medium text-gray-600">
              {i + 1}
            </span>
            <input
              type="text"
            ...
            {items.length > 1 && (
              <button
                type="button"
                onClick={() => onRemove(i)}
                className="p-2 cursor-pointer rounded-lg bg-red-400 hover:bg-red-600 hover:text-white transition-colors shrink-0"
              >
                <TrashIcon className="w-4.5 h-4.5 text-white" />
              </button>
            )}
          </div>
        ))}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="min-h-[500px]">
          <div className="bg-white rounded-lg pt-10 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden animate-in fade-in slide-in-from-right-5 duration-500">
            ...
            {/* ── Step headers ── */}
            {currentStep === 1 && (
              <div className="px-8 py-4 border-10 border-white bg-gray-100/80 flex items-center gap-3">
            ...
            <div className="p-10 pt-5">
              ...
              {currentStep === 2 && (
                <div className="space-y-8 animate-in fade-in slide-in-from-right-3 duration-500">
                  ...
                  <div className="space-y-3">
                    <div className="flex border-b border-gray-200 mb-5 pb-3 items-center justify-between ml-1">
                      <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex items-center border border-indigo-200 gap-1 text-xs font-bold text-indigo-600 hover:text-indigo-800 transition-colors px-2 py-1 rounded-lg hover:bg-indigo-50"
                      >
                        ...
                        <thead className="bg-gray-50 border-b border-gray-200">
                          <tr>
                            {["Semester", "Course Type", "Course Name", "Credits", ""].map((h) => (
                              <th key={h} className="px-3 py-2.5 text-left text-[11px] font-semibold text-gray-600 uppercase tracking-wider">
                                {h}
                              </th>
                            ))}
                          </tr>
                              ...
                              {(["sem", "courseType", "courseName"] as const).map((field) => (
                                <td key={field} className="px-2 py-1.5">
                                  <input
                                    ...
                                    className="w-full px-2.5 py-1.5 rounded-lg bg-white border border-gray-200 text-xs text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 transition-all"
                                    placeholder={
                                      field === "sem" ? "e.g. Sem 1" :
                        ...
                        <div className="space-y-3 text-center">
                          ...
                          <div className="flex flex-col text-sm text-gray-600">
                            <span className="font-bold text-gray-800 text-lg line-clamp-1">
                              {file ? file.name : "Fee Structure"}
                            </span>
                            {!file && <p className="text-slate-400">Choose or drag fee doc</p>}
                          </div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <div className="space-y-3 text-center">
                          ...
                          <div className="flex flex-col text-sm text-gray-600">
                            <span className="font-bold text-gray-800 text-lg line-clamp-1">
                              {brochureFile ? brochureFile.name : "Program Brochure"}
                            </span>
                            {!brochureFile && <p className="text-slate-400">Choose or drag brochure</p>}
                          </div>
                          <p className="text-[10px] text-slate-400 uppercase tracking-widest font-medium bg-white/50 px-3 py-1 rounded-full inline-block border border-gray-100">
                            PDF, PNG, JPG (MAX. 10MB)
                          </p>
