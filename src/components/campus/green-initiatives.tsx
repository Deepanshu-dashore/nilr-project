    ...
    >
      ...
      <div className="container-wide pl-5 md:pl-0 relative z-10 text-white">
        ...
        <div className="flex items-center gap-4 mb-10 md:mb-12 max-w-6xl">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 md:w-6 md:h-6 text-green-500 shrink-0" viewBox="0 0 48 48">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-y-10 gap-x-10 lg:gap-x-20 max-w-5xl mx-auto">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="flex gap-4 items-start">
              <MapIcon className="w-10 h-10 md:w-11 md:h-11 p-2 text-green-100 rounded-sm mt-1 shrink-0 bg-green-500" />
            ...
            <div className="flex gap-4 items-start">
              <GlobeAsiaAustraliaIcon className="w-10 h-10 md:w-11 md:h-11 p-2 text-green-100 rounded-sm mt-1 shrink-0 bg-green-500" />
              <p className="text-sm md:text-base font-medium leading-relaxed text-white/90">
            ...
            <div className="flex gap-4 items-start">
              <ArchiveBoxIcon className="w-10 h-10 md:w-11 md:h-11 p-2 text-green-100 rounded-sm mt-1 shrink-0 bg-green-500" />
              <p className="text-sm md:text-base font-medium leading-relaxed text-white/90">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="flex gap-4 items-start">
              <BeakerIcon className="w-10 h-10 md:w-11 md:h-11 p-2 text-green-100 rounded-sm mt-1 shrink-0 bg-green-500" />
              <p className="text-sm md:text-base font-medium leading-relaxed text-white/90">
            ...
            <div className="flex gap-4 items-start">
              <SunIcon className="w-10 h-10 md:w-11 md:h-11 p-2 text-green-100 rounded-sm mt-1 shrink-0 bg-green-500" />
              <p className="text-sm md:text-base font-medium leading-relaxed text-white/90">
        ...
        {/* Footer Tagline */}
        <div className="mt-12 md:mt-16 border-t border-white/10 pt-6 text-center">
          <p className="text-[13px] md:text-base font-semibold tracking-wider text-white/80 uppercase">
